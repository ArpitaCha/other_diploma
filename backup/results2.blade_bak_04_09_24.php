        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th colspan="1" rowspan="2"> IIHM/VOC/FDI</th>
            ...
            <tbody>
                <tr>
                <?php 
                        if(($th_cnt > 0) && ($ses_cnt > 0) && ($tot_paper_cnt == 8)){
                ...
                <tr>
                    <td colspan="2" rowspan="1"style="font-weight: bold;">Full Marks</td>
                         <?php 
                        if(($th_cnt > 0) && ($ses_cnt > 0) && ($tot_paper_cnt == 8)){//if theory and sessional paper count is 8
                    ...
                    <?php    }
                            ...
                            elseif(($th_cnt > 0) && ($ses_cnt == 0)){ //if theory paper 5 and no sessional paper
                                foreach ($theory_papers as $k => $v){
               ...
               @php
                ...
                @foreach ($students as $skey => $student)
                    ...
                    <tr>
                        ...
                        <td>{{ $student['sub8_ext_session_marks'] }}</td>
                        </td>
