...
class ResultProcessExtraController extends Controller
{
        ...
        if (sizeof($resultData) > 0) {
            foreach ($resultData as $key => $row) {
                ...
                Result::where('REG_NO', $row['REG_NO'])->update([
                    'SUB1_TH_INT_MK_2024' => $SUB1_INT_VIVA_CLASS_MK,
                    'SUB2_TH_INT_MK_2024' => $SUB2_INT_VIVA_CLASS_MK,
                    'SUB3_TH_INT_MK_2024' => $SUB3_INT_VIVA_CLASS_MK,
                    'SUB4_TH_INT_MK_2024' => $SUB4_INT_VIVA_CLASS_MK,
                    'SUB5_TH_INT_MK_2024' => $SUB5_INT_VIVA_CLASS_MK,
                    'SUB6_TH_INT_MK_2024' => $SUB6_INT_VIVA_CLASS_MK,
                    'SUB7_TH_INT_MK_2024' => $SUB7_INT_VIVA_CLASS_MK,
                    'SUB8_TH_INT_MK_2024' => $SUB8_INT_VIVA_CLASS_MK,
                    'SUB9_SES_INT_MK_2024' =>$SUB9_SES_INT_VIVA_CLASS_MK,
                    'SUB10_SES_INT_MK_2024' =>$SUB10_SES_INT_VIVA_CLASS_MK,
                    'SUB11_SES_INT_MK_2024' =>$SUB11_SES_INT_VIVA_CLASS_MK,
                    'SUB12_SES_INT_MK_2024' =>$SUB12_SES_INT_VIVA_CLASS_MK,
                    'SUB13_SES_INT_MK_2024' =>$SUB13_SES_INT_VIVA_CLASS_MK,
                    'SUB14_SES_INT_MK_2024' =>$SUB14_SES_INT_VIVA_CLASS_MK,
                    'SUB9_SES_EXT_MK_2024' =>$SUB9_SES_EXT_VIVA_CLASS_MK,
                    'SUB10_SES_EXT_MK_2024' =>$SUB10_SES_EXT_VIVA_CLASS_MK,
                    'SUB11_SES_EXT_MK_2024' =>$SUB11_SES_EXT_VIVA_CLASS_MK,
                    'SUB12_SES_EXT_MK_2024' =>$SUB12_SES_EXT_VIVA_CLASS_MK,
                    'SUB13_SES_EXT_MK_2024' =>$SUB13_SES_EXT_VIVA_CLASS_MK,
                    'SUB14_SES_EXT_MK_2024' =>$SUB14_SES_EXT_VIVA_CLASS_MK,
    ...
    public function resultProcessScriptStep2(Request $request)
    {
        ...
        if (sizeof($resultData) > 0) {
            foreach ($resultData as $key => $row) {
                ...
                $SUB9_INT_OB_MK = (int)$row['SUB9_SES_INT_MK_' . $year . ''] + (int)$row['SUB9_SES_INT_ATD_MK_' . $year . ''];
                $SUB9_EXT_OB_MK = (int)$row['SUB9_SES_EXT_MK_' . $year . ''] ;

                $SUB10_INT_OB_MK =(int) $row['SUB10_SES_INT_MK_' . $year . ''] + (int)$row['SUB10_SES_INT_ATD_MK_' . $year . ''];
                $SUB10_EXT_OB_MK =(int) $row['SUB10_SES_EXT_MK_' . $year . ''];

                $SUB11_INT_OB_MK = (int)$row['SUB11_SES_INT_MK_' . $year . ''] + (int)$row['SUB11_SES_INT_ATD_MK_' . $year . ''];
                $SUB11_EXT_OB_MK =(int) $row['SUB11_SES_EXT_MK_' . $year . ''];

                $SUB12_INT_OB_MK =(int) $row['SUB12_SES_INT_MK_' . $year . ''] + (int)$row['SUB12_SES_INT_ATD_MK_' . $year . ''];
                $SUB12_EXT_OB_MK =(int) $row['SUB12_SES_EXT_MK_' . $year . ''];

                $SUB13_INT_OB_MK =(int) $row['SUB13_SES_INT_MK_' . $year . ''] + (int)$row['SUB13_SES_INT_ATD_MK_' . $year . ''];
                $SUB13_EXT_OB_MK =(int) $row['SUB13_SES_EXT_MK_' . $year . ''];

                $SUB14_INT_OB_MK =(int) $row['SUB14_SES_INT_MK_' . $year . '']  + (int)$row['SUB14_SES_INT_ATD_MK_' . $year . ''];
                $SUB14_EXT_OB_MK =(int) $row['SUB14_SES_EXT_MK_' . $year . ''];
                $credit = "";
                //dd($SUB1_OB_MK);
    ...
    public function resultProcessScriptStep5(Request $request)
    {
        ...
        if (sizeof($resultData) > 0) {
            foreach ($resultData as $key => $row) {
                ...
                $SUB9_INT_OB_MK = (int)$row['SUB9_SES_INT_MK_' . $year . ''];
                $SUB9_INT_ATD_MK = (int)$row['SUB9_SES_INT_ATD_MK_' . $year . ''];
                $SUB9_EXT_OB_MK = (int)$row['SUB9_SES_EXT_MK_' . $year . ''];
                $SUB9_OB_MK = ($SUB9_INT_OB_MK + $SUB9_EXT_OB_MK + $SUB9_INT_ATD_MK);

                $SUB10_INT_OB_MK = (int)$row['SUB10_SES_INT_MK_' . $year . ''];
                $SUB10_INT_ATD_MK = (int)$row['SUB10_SES_INT_ATD_MK_' . $year . ''];
                $SUB10_EXT_OB_MK = (int)$row['SUB10_SES_EXT_MK_' . $year . ''];
                $SUB10_OB_MK = ($SUB10_INT_OB_MK + $SUB10_EXT_OB_MK + $SUB10_INT_ATD_MK);

                $SUB11_INT_OB_MK = (int)$row['SUB11_SES_INT_MK_' . $year . ''];
                $SUB11_INT_ATD_MK = (int)$row['SUB11_SES_INT_ATD_MK_' . $year . ''];
                $SUB11_EXT_OB_MK = (int)$row['SUB11_SES_EXT_MK_' . $year . ''];
                $SUB11_OB_MK = ($SUB11_INT_OB_MK + $SUB11_EXT_OB_MK + $SUB11_INT_ATD_MK) ;

                $SUB12_INT_OB_MK = (int)$row['SUB12_SES_INT_MK_' . $year . ''];
                $SUB12_INT_ATD_MK = (int)$row['SUB12_SES_INT_ATD_MK_' . $year . ''];
                $SUB12_EXT_OB_MK = (int)$row['SUB12_SES_EXT_MK_' . $year . ''];
                $SUB12_OB_MK = ($SUB12_INT_OB_MK + $SUB12_EXT_OB_MK + $SUB12_INT_ATD_MK);


                $SUB13_INT_OB_MK = (int)$row['SUB13_SES_INT_MK_' . $year . ''];
                $SUB13_INT_ATD_MK = (int)$row['SUB13_SES_INT_ATD_MK_' . $year . ''];
                $SUB13_EXT_OB_MK = (int)$row['SUB13_SES_EXT_MK_' . $year . ''];
                $SUB13_OB_MK = ($SUB13_INT_OB_MK + $SUB13_EXT_OB_MK + $SUB13_INT_ATD_MK);

                $SUB14_INT_OB_MK = (int)$row['SUB14_SES_INT_MK_' . $year . ''];
                $SUB14_INT_ATD_MK = (int)$row['SUB14_SES_INT_ATD_MK_' . $year . ''];
                $SUB14_EXT_OB_MK = (int)$row['SUB14_SES_EXT_MK_' . $year . ''];
                $SUB14_OB_MK = ($SUB14_INT_OB_MK + $SUB14_EXT_OB_MK + $SUB14_INT_ATD_MK);
                $credit = "";
    ...
    public function resultProcessScriptStep6(Request $request)
    {
        ...
        if (sizeof($resultData) > 0) {
            foreach ($resultData as $key => $row) {
                ...
                if (
                    ($row["SUB9_SES_INT_MK_" . $year] == "AB") ||
                    ($row["SUB9_SES_INT_ATD_MK_" . $year] == "AB") ||
                    ($row["SUB9_SES_EXT_MK_" . $year] == "AB")
                ) {
                    $is_s9_abs = 1;
                }
                if (
                    ($row["SUB10_SES_INT_MK_" . $year] == "AB") ||
                    ($row["SUB10_SES_INT_ATD_MK_" . $year] == "AB") ||
                    ($row["SUB10_SES_EXT_MK_" . $year] == "AB")
                ) {
                    $is_s10_abs = 1;
                }
                if (
                    ($row["SUB11_SES_INT_MK_" . $year] == "AB") ||
                    ($row["SUB11_SES_INT_ATD_MK_" . $year] == "AB") ||
                    ($row["SUB11_SES_EXT_MK_" . $year] == "AB")
                ) {
                    $is_s11_abs = 1;
                }
                if (
                    ($row["SUB12_SES_INT_MK_" . $year] == "AB") ||
                    ($row["SUB12_SES_INT_ATD_MK_" . $year] == "AB") ||
                    ($row["SUB12_SES_EXT_MK_" . $year] == "AB")
                ) {
                    $is_s12_abs = 1;
                }
                if (
                    ($row["SUB13_SES_INT_MK_" . $year] == "AB") ||
                    ($row["SUB13_SES_INT_ATD_MK_" . $year] == "AB") ||
                    ($row["SUB13_SES_EXT_MK_" . $year] == "AB")
                ) {
                    $is_s13_abs = 1;
                }
                if (
                    ($row["SUB14_SES_INT_MK_" . $year] == "AB") ||
                    ($row["SUB14_SES_INT_ATD_MK_" . $year] == "AB") ||
                    ($row["SUB14_SES_EXT_MK_" . $year] == "AB")
                ) {
                    $is_s14_abs = 1;
                }
