...
Route::get('payment-redirect/{trans_id}/{order_id}/{paying_for}/{message}/{currency}/{trans_amount}/{trans_time}/{appl_num}/{trans_status}', function ($trans_id, $order_id, $paying_for, $message, $currency, $trans_amount, $trans_time,$appl_num, $trans_status) {
