                ...
                <tr>
                    ...
                    <td style="border:1px solid #000000;height:26.4px;padding:0px;vertical-align:top;width:100px;">
                        <p style="line-height:1; text-align: center;">
                            <span style="font-family:Cambria;font-size:10.67px;">
                                ...
                                <span style="color: green;">(Full Marks: {{$students[0]['paper_internal_attendance_marks']}})</span>
                            </span>
                        </p>
                    </td>
                    <td style="border:1px solid #000000;height:26.4px;padding:0px;vertical-align:top;width:100px;">
                        <p style="line-height:1; text-align: center;">
                            <span style="font-family:Cambria;font-size:10.67px;">
                                ...
                                <span style="color: green;">(Full Marks:{{$students[0]['paper_internal_theory_class_test_marks']}} )</span>
                            </span>
                        </p>
                    </td>
                    <td style="border:1px solid #000000;height:26.4px;padding:0px;vertical-align:top;width:100px;">
                        <p style="line-height:1; text-align: center;">
                            <span style="font-family:Cambria;font-size:10.67px;">
                                <span style="font-stretch:100%;text-align:center;">
                                    <strong>Assignment/Viva voce</strong>
                                </span><br>
                                <span style="color: green;">(Full Marks: {{$students[0]['paper_internal_theory_viva_marks']}})</span>
                            </span>
                        </p>
                    </td>
                    <td style="border:1px solid #000000;height:26.4px;padding:0px;vertical-align:top;width:100px;">
                        <p style="line-height:1; text-align: center;">
                            <span style="font-family:Cambria;font-size:10.67px;">
                                ...
                                <span style="color: green;">(Full Marks: {{$marks}})</span>
                            </span>
                        </p>
                    </td>
                    ...
                    <td style="border:1px solid #000000;height:26.4px;padding:0px;vertical-align:top;width:100px;">
                        <p style="line-height:1; text-align: center;">
                            <span style="font-family:Cambria;font-size:10.67px;">
                                ...
                                <span style="color: green;">(Full Marks: {{ $students[0]['paper_sessional_internal_attendance_marks'] }})</span>
                            </span>
                        </p>
                    </td>
                    <td style="border:1px solid #000000;height:26.4px;padding:0px;vertical-align:top;width:100px;">
                        <p style="line-height:1; text-align: center;">
                            <span style="font-family:Cambria;font-size:10.67px;">
                                ...
                                <span style="color: green;">(Full Marks:{{ $students[0]['paper_sessional_internal_class_test_marks'] }})</span>
                            </span>
                        </p>
                    </td>
                    <td style="border:1px solid #000000;height:26.4px;padding:0px;vertical-align:top;width:100px;">
                        <p style="line-height:1; text-align: center;">
                            <span style="font-family:Cambria;font-size:10.67px;">
                                ...
                                <span style="color: green;">(Full Marks:{{ $students[0]['paper_sessional_internal_viva_marks'] }} )</span>
                            </span>
                        </p>
                    </td>
                    <td style="border:1px solid #000000;height:26.4px;padding:0px;vertical-align:top;width:100px;">
                    ...
                    <td style="border:1px solid #000000;height:26.4px;padding:0px;vertical-align:top;width:100px;">
                        <p style="line-height:1; text-align: center;">
                            <span style="font-family:Cambria;font-size:10.67px;">
                                <span style="font-stretch:100%;text-align:center;">
                                    <strong>Assignment on the day of viva voce</strong>
                                </span><br>
                                
                                <span style="color: green;">(Full Marks:{{ $students[0]['paper_sess_assign_viva_marks'] }} )</span>
                            </span>
                        </p>
                    </td>
                    <td style="border:1px solid #000000;height:26.4px;padding:0px;vertical-align:top;width:100px;">
                        <p style="line-height:1; text-align: center;">
                            <span style="font-family:Cambria;font-size:10.67px;">
                                <span style="font-stretch:100%;text-align:center;">
                                    <strong>Viva Voce(before board of Examiners)</strong>
                                </span><br>
                                <span style="color: green;">(Full Marks: {{ $students[0]['paper_sess_before_viva_marks'] }})</span>
                            </span>
                        </p>
                    </td>
                    <td style="border:1px solid #000000;height:26.4px;padding:0px;vertical-align:top;width:100px;">
                ...
                @foreach ($students as $row)
                    <tr>
                       ...
                       <!-- <td
                        ...
                        @if($paper_type == '1' && $subject_entry_type == '1' || $paper_type == '2' && $subject_entry_type == '1')
                        <td
                            style="border:1px solid #000000;height:17.6px;padding:0px;vertical-align:top;width:100px;">
                            <p style="line-height:1;margin:0px; text-align: center;">
                                <span style="font-family:Cambria;font-size:10.67px;">
                        ...
                        @else if($paper_type == '1' && $subject_entry_type == '2')
                        <td
                            style="border:1px solid #000000;height:17.6px;padding:0px;vertical-align:top;width:100px;">
                            <p style="line-height:1;margin:0px; text-align: center;">
                                <span style="font-family:Cambria;font-size:10.67px;">
